...
paplot qc qc_multi_plot/data.csv ./demo qc_multi    --ellipsis multi_plot --config_file ./qc_multi_plot/paplot.cfg
...
paplot signature "signature_integral/data*.json" ./demo signature_integral --ellipsis integral --config_file ./signature_integral/paplot.cfg
...
paplot pmsignature "pmsignature_integral/data*.json" ./demo pmsignature_integral --ellipsis integral --config_file ./pmsignature_integral/paplot.cfg
