...
msig_data.signatures = ['signature 1',];
msig_data.sig_colors = ['#66C2A5',];

msig_data.dataset_ref = [[[0.303,0.196,0.199,0.3],[0.284,0.242,0.196,0.276],[0,0.595,0,0.404],[0.27,0.219,0.197,0.312],[0.28,0.201,0.196,0.32],],];
msig_data.dataset_alt = [[[0,0,0,0],[0.187,0,0.143,0.264],[0,0,0,0],[0.137,0.167,0.099,0],],];
msig_data.dataset_strand = [[0.484,0.515],];
