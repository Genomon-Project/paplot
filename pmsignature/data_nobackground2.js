...
msig_data.signatures = ['signature 1','signature 2',];
msig_data.sig_colors = ['#66C2A5','#FC8D62',];

msig_data.dataset_ref = [[[0.303,0.196,0.199,0.3],[0.284,0.242,0.196,0.276],[0,0.595,0,0.404],[0.27,0.219,0.197,0.312],[0.28,0.201,0.196,0.32],],[[0.177,0.413,0.084,0.324],[0.009,0.026,0.007,0.956],[0,0.999,0,0],[0.475,0.105,0.041,0.377],[0.274,0.176,0.287,0.261],],];
msig_data.dataset_alt = [[[0,0,0,0],[0.187,0,0.143,0.264],[0,0,0,0],[0.137,0.167,0.099,0],],[[0,0,0,0],[0.059,0,0.432,0.507],[0,0,0,0],[0,0,0,0],],];
msig_data.dataset_strand = [[0.484,0.515],[0.514,0.485],];
